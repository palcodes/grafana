...
import { Button, DeleteButton, HorizontalGroup, useStyles2 } from '@grafana/ui';
              ...
              <tbody>
                {correlations.map((ds, i) =>
                  ds.correlations.map((correlation, j) => (
                    <tr className={cx({ [tableStyles.oddRow]: (i + j) % 2 === 0 })} key={correlation.uid}>
                      <td>
                      ...
                      <td></td>
                      <td>
                        <DeleteButton onConfirm={() => remove(ds, correlation.uid)} size="sm" />
                      </td>
                    </tr>
                  ))
                )}
